...
- [Next.js Documentation](https://nextjs.org/docs) - Learn about Next.js features and routing
- [FastAPI Documentation](https://fastapi.tiangolo.com/) - Understand FastAPI routing and middleware
- [AWS App Runner Documentation](https://docs.aws.amazon.com/apprunner/) - Official AWS guide
- [Clerk Documentation](https://clerk.com/docs) - Authentication and user management
- [OpenAI API Documentation](https://platform.openai.com/docs) - AI model usage and best practices

---

**Last Updated:** January 2024

**Maintained by:** MediNotes Pro Team